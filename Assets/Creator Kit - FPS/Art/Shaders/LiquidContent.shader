    ...
    SubShader
    {
        ...
        Pass
        {
         ...
         v2f vert (appdata v)
         {
            ...
            float yScale = length(mul(unity_ObjectToWorld, float3(0,1,0)));			
...
//            float3 worldPosAdjusted = worldPos + (worldPosX  * _WobbleX)+ (worldPosZ* _WobbleZ); 
            ...
            float3 worldPosAdjusted = mul(_LiquidRotation, float4(worldPos,1)).xyz;
            
            o.fillEdge = worldPosAdjusted.y - _FillAmount*yScale;
